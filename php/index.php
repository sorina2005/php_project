...
<br>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="../images/baked-apple.webp" class="card-img-top" alt="..." style="height: 240px">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="../images/pancake-tacos.jpg" class="card-img-top" alt="..." style="height: 240px">
                        <div class="card-body">
    ...
    <section id="slider">
            ...
            <div class="slider">
                <div class="list">
                    <div class="item">
                        <img src="../images/photos from you/1.JPG" >
                    </div>
                    <div class="item">
                        <img src="../images/photos from you/2.JPG" >
                    </div>
                    <div class="item">
                        <img src="../images/photos from you/3.jpeg" >
                    </div>
                    <div class="item">
                        <img src="../images/photos from you/4.jpeg" >
                    </div>
                    <div class="item">
                        <img src="../images/photos from you/5.jpeg" >
                    </div>
                    <div class="item">
                        <img src="../images/photos from you/6.jpeg" >
                    </div>
                    <div class="item">
                        <img src="../images/photos from you/7.JPG" >
                    </div>
                </div>
                <div class="buttons">
